    ...
    onMount(() => {
        let ctx = gsap.context(() => {        
            ...
            mm.add('(min-width:768px)', () => {
                ...
                .fromTo('.career', {yPercent:100, x:0, xPercent:0, opacity:0}, {yPercent:-50, opacity:1, delay:1, duration:2})
                .to('.career', {yPercent:-150, opacity:0, delay:2, duration:2})
                .fromTo('.edu', {yPercent:100, x:0, xPercent:0, opacity:0}, {yPercent:-50, opacity:1, delay:1, duration:2}, '<')
                .to('.edu', {yPercent:-150, opacity:0, delay:2, duration:2})
                .fromTo('.tools', {yPercent:100, x:0, xPercent:0, opacity:0}, {yPercent:-50, opacity:1, delay:1, duration:2,
                    onStart: () => {
                        toolItems.forEach(x => {
                ...
                .fromTo('.skills', {yPercent:100, x:0, xPercent:0, opacity:0}, {yPercent:-50, opacity:1, delay:1, duration:2,
                    onStart: () => {
            ...
            mm.add('(max-width:768px)', () => {
                ...
                .fromTo('.career', {xPercent:100, y:0, yPercent:0, opacity:0}, {xPercent:5, opacity:1, delay:1, duration:2}, '<')
                .to('.career', {xPercent:-100, opacity:0, delay:2, duration:2})
                .fromTo('.edu', {xPercent:100, y:0, yPercent:0, opacity:0}, {xPercent:5, opacity:1, delay:1, duration:2})
                .to('.edu', {xPercent:-100, opacity:0, delay:2, duration:2})
                .fromTo('.tools', {xPercent:100, y:0, yPercent:0, opacity:0}, {xPercent:5, opacity:1, delay:1, duration:2,
                    onStart: () => {
                        toolItems.forEach(x => {
                            gsap.fromTo(x.querySelector('img'), {scale:0}, {scale:1, delay:0.3})
                            gsap.fromTo(x.querySelector('p'), {yPercent:100, opacity:0}, {yPercent:0, opacity:1, delay:0.6})
                ...
                .fromTo('.skills', {xPercent:100, y:0, yPercent:0, opacity:0}, {xPercent:5, opacity:1, delay:1, duration:2,
                    onStart: () => {
                        gauges.forEach((x, idx) => {
                            gsap.fromTo(x, {scaleX:0}, {scaleX:1, duration:0.8, ease:'none', delay:(idx+1)*0.15})
                        })
